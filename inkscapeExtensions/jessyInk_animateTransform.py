...
class JessyInk_AnimateTransform(inkex.Effect):
	def __init__(self):
	...
	def effect(self):
		...
		for id, node in list(self.selected.items()):
			...
			# Add the animation
			attribs = {'attributeName':'transform',
			...
			inkex.etree.SubElement(clone, inkex.addNS('animateTransform','svg'), attribs)

		

# Create effect instance
effect = JessyInk_AnimateTransform()
effect.affect()
